      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          {form.formState.errors.goalDetailsStep?.title && (
            <small className="text-destructive">{form.formState.errors.goalDetailsStep.title.message}</small>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {form.formState.errors.goalDetailsStep?.description && (
            <small className="text-destructive">{form.formState.errors.goalDetailsStep.description.message}</small>
          )}
        </div>
        ...
        <div className="flex flex-col space-y-2">
          ...
          {form.formState.errors.goalDetailsStep?.startDate && (
            <small className="text-destructive">{form.formState.errors.goalDetailsStep.startDate.message}</small>
          )}
        </div>
